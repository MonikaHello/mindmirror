    ...
    <div className="min-h-screen" style={{ background: '#f6f4f0', color: '#0a0a0a', fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif" }}>
      ...
      <section className="min-h-screen px-10 pt-32 pb-20 max-w-6xl mx-auto flex items-center gap-16">
        <div className="flex-1">
          <Image src="/logo.png" alt="MindMirror" width={200} height={200} className="mb-8" />
        ...
        <div className="flex-1">
          <div className="w-full rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: '3/4' }}>
            <Image src="/hero.jpg" alt="Mirror reflection" width={400} height={533} className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      ...
      <section id="import" className="py-28 px-10" style={{ background: '#f2e6d5' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-4xl font-light text-center mb-4">
            Already journal on paper?<br />Import it.
          </h2>
          ...
          <div className="grid grid-cols-4 gap-5 mb-14">
            {[
              ...
              <div key={i} className="rounded-2xl p-6 text-center flex flex-col" style={{ background: '#f6f4f0', minHeight: '180px' }}>
      ...
      <section id="the-science" className="py-28 px-10" style={{ background: 'white' }}>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs font-semibold tracking-widest mb-4" style={{ color: '#69443c', letterSpacing: '0.16em' }}>THE SCIENCE</p>
          <h2 className="text-4xl font-light mb-7">
            Predictive Processing and<br />Active Inference
          </h2>
          <p className="text-lg leading-relaxed mb-7" style={{ color: '#6b6b6b' }}>
            ...
            from a lifetime of experience. This is <em>predictive processing</em>: perception as prediction. 
          ...
          <p className="text-lg leading-relaxed" style={{ color: '#6b6b6b' }}>
            But the brain does not stop at perception. Through <em>active inference</em>, it also acts to make predictions come true:
          ...
          <div className="rounded-2xl p-8 mt-10 mx-auto max-w-xl" style={{ background: '#f6f4f0' }}>
            <p className="text-base leading-relaxed mb-3" style={{ color: '#6b6b6b' }}>
      ...
      {/* Why We Ask */}
      <section className="py-24 px-10" style={{ background: '#f6f4f0' }}>
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-semibold tracking-widest mb-4 text-center" style={{ color: '#69443c', letterSpacing: '0.16em' }}>WHAT WE TRACK & WHY</p>
          <h2 className="text-4xl font-light text-center mb-14">
            Why We Ask About Each Layer
          </h2>
          <div className="grid grid-cols-2 gap-7">
            {[
              { title: "Thoughts", sub: "Your brain's running commentary",
                body: "Thoughts reveal your priors in action. \"I'm going to fail\" isn't just a thought. It's a prediction your brain generated based on past experience. Tracking thoughts makes invisible predictions visible.",
                bg: 'white', cite: "Clark, A. (2015). Surfing Uncertainty. Oxford University Press." },
              { title: "Feelings", sub: "Predictions about your body's state",
                body: "Emotions aren't reactions. They're predictions. Your brain constructs feelings by predicting what bodily sensations mean in context. Tracking emotions reveals which predictions your brain defaults to.",
                bg: '#f2e6d5', cite: "Barrett, L. F. (2017). How Emotions Are Made. Houghton Mifflin Harcourt." },
              { title: "Body Sensations", sub: "The interoceptive signal",
                body: "Chest tightness, stomach knots, shallow breathing. Your body sends signals that shape emotional predictions. Somatic awareness helps you notice and interrupt automatic patterns.",
                bg: '#f2e6d5', cite: "Seth, A. K. & Friston, K. J. (2016). Phil. Trans. R. Soc. B, 371(1708)." },
              { title: "Body State", sub: "Sleep, cycle & health factors",
                body: "When dysregulated (poor sleep, hormonal shifts, illness) negative priors become rigid and resistant to updating. Tracking physical state reveals when your brain is most open to change.",
                bg: 'white', cite: "Friston, K. J. et al. (2014). The Lancet Psychiatry, 1(2), 148–158." },
            ].map((item, i) => (
              <div key={i} className="rounded-full p-12 text-center flex flex-col justify-center" style={{ background: item.bg, height: '280px', border: item.bg === 'white' ? '1px solid rgba(0,0,0,0.04)' : 'none' }}>
                <p className="text-xs font-semibold tracking-wide mb-1" style={{ color: '#69443c', letterSpacing: '0.14em' }}>{item.sub.toUpperCase()}</p>
      ...
      <section id="research" className="py-28 px-10" style={{ background: 'white' }}>
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-semibold tracking-widest mb-4 text-center" style={{ color: '#69443c', letterSpacing: '0.16em' }}>RESEARCH</p>
          <h2 className="text-4xl font-light text-center mb-3">
            What the Evidence Shows
          </h2>
          <p className="text-base text-center max-w-xl mx-auto mb-12" style={{ color: '#6b6b6b' }}>
          ...
          <div className="grid grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className="p-7 rounded-2xl" style={{ background: i % 3 === 1 ? '#f8f0e8' : '#f6f4f0', border: '1px solid rgba(0,0,0,0.04)' }}>
                <h4 className="text-base font-semibold mb-2">{s.t}</h4>
                <p className="text-sm leading-relaxed mb-3" style={{ color: '#6b6b6b' }}>{s.b}</p>
      ...
      <section id="the-model" className="py-28 px-10" style={{ background: '#f6f4f0' }}>
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-semibold tracking-widest mb-4 text-center" style={{ color: '#69443c', letterSpacing: '0.16em' }}>THE MODEL</p>
          <h2 className="text-4xl font-light text-center mb-14">
          ...
          <div className="grid grid-cols-2 gap-9">
            {[
              ...
              <div key={i} className="flex gap-5">
                <div className="text-4xl font-extralight" style={{ color: '#69443c', minWidth: '56px' }}>{s.n}</div>
                <div>
      ...
      <section className="py-28 px-10" style={{ background: 'white' }}>
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-semibold tracking-widest mb-4 text-center" style={{ color: '#69443c', letterSpacing: '0.16em' }}>WHO IS THIS FOR</p>
          <h2 className="text-4xl font-light text-center mb-14">
          ...
          <div className="grid grid-cols-2 gap-7">
            {[
              ...
              <div key={i} className="p-9 rounded-2xl" style={{ background: '#f6f4f0', border: '1px solid rgba(0,0,0,0.03)' }}>
                <h3 className="text-lg font-medium mb-2">{item.l}</h3>
      ...
      <section className="py-28 px-10" style={{ background: '#f6f4f0' }}>
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-4xl font-light mb-12">Pricing</h2>
          <div className="grid grid-cols-2 gap-6">
            <div className="p-10 rounded-2xl text-center flex flex-col justify-between" style={{ background: 'white', border: '1px solid rgba(0,0,0,0.04)', height: '340px' }}>
              <div>
                <p className="text-sm mb-1" style={{ color: '#999' }}>Free</p>
              ...
              <Link href="/signup" className="btn w-full mt-6">Get Started</Link>
            </div>
            <div className="p-10 rounded-2xl text-center flex flex-col justify-between" style={{ background: '#f2e6d5', height: '340px' }}>
              <div>
                <p className="text-sm font-semibold mb-1" style={{ color: '#69443c' }}>Premium</p>
              ...
              <Link href="/signup" className="btn btn-primary w-full mt-6">Start Free Trial</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-20 px-10 text-center" style={{ background: '#69443c' }}>
        <Image src="/logo.png" alt="MindMirror" width={60} height={60} className="mx-auto mb-5 invert" />
        <p className="text-base mb-9" style={{ color: '#d4c4bc' }}>
          See your predictions. Update your priors.
        </p>
        <Link href="/signup" className="inline-block py-3.5 px-9 rounded-full text-sm font-medium" style={{ background: '#f6f4f0', color: '#69443c' }}>Start Free</Link>
        <div className="mt-12 pt-8 flex justify-center gap-7 text-xs" style={{ borderTop: '1px solid rgba(212,196,188,0.3)', color: 'rgba(212,196,188,0.7)' }}>
